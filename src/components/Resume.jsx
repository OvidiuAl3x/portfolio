              ...
              <div className="border-2 border-emerald-500 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <ul className="list-disc mt-2 marker:text-emerald-700 text-sm">
                  ...
                  <li>
                    ...
                    Front-End, Back-End, DevOps mentors, scrum master and
                    product owner) on an recipes application, meeting all
                    project deadlines,
                  </li>
                  <li>
                  ...
                  <li>
                    Successfully implemented Yup for form validation on
                    [website],
                  </li>
                  <li>
