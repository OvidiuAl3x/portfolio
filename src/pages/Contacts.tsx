...
const Contacts = () => {
  return (
    <Animation props="animate-opacity mt-20">
      <div
        id="contacts"
        className="flex flex-wrap md:flex-nowrap gap-5 items-center justify-between  md:mt-0  text-grayLight"
      >
        ...
        <div className="flex flex-col font-openSans text-lg gap-8 order-1 md:order-2">
          ...
          <div className="border-2 border-grayLight rounded-xl p-5 flex flex-col gap-3 w-[280px] lg:w-[350px] font-firaCode">
            <p>Site</p>
      ...
      <div className="flex flex-wrap gap-5 font-openSans mt-5 mb-10">
        ...
        <div className="flex items-center gap-3 text-grayLight hover:text-textWhite rounded-xl border-2 border-grayLight px-5 py-2 italic">
