...
const Home = () => {
  return (
    <>
      <Header />
      <div className="flex flex-col justify-center items-center md:h-[100vh] gap-5 font-firaCode mt-10 md:mt-0">
        <div className="grid md:grid-cols-2  xl:w-[80%] gap-5">
          ...
          <p className="w-[350px] font-openSans text-grayLight order-3 md:order-3">
            ...
            I'm a{" "}
            <span className="italic text-textWhite">self-taught coder</span> who
